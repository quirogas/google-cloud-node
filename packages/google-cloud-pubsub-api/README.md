...
[![npm version](https://img.shields.io/npm/v/@google-cloud/pubsub-api.svg)](https://www.npmjs.org/package/@google-cloud/pubsub-api)

Cloud Pub/Sub API client for Node.js

> **Notice**: `@google-cloud/pubsub-api` is an internal low-level GAPIC client intended to be consumed by `@google-cloud/pubsub`. Most users should install [`@google-cloud/pubsub`](https://www.npmjs.com/package/@google-cloud/pubsub) instead.
