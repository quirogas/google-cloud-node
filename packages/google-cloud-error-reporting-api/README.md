...
[![npm version](https://img.shields.io/npm/v/@google-cloud/error-reporting-api.svg)](https://www.npmjs.org/package/@google-cloud/error-reporting-api)

Error Reporting API client for Node.js

> **Notice**: `@google-cloud/error-reporting-api` is an internal low-level GAPIC client intended to be consumed by `@google-cloud/error-reporting`. Most users should install [`@google-cloud/error-reporting`](https://www.npmjs.com/package/@google-cloud/error-reporting) instead.
