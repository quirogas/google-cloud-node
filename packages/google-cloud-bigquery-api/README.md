...
[![npm version](https://img.shields.io/npm/v/@google-cloud/bigquery-api.svg)](https://www.npmjs.org/package/@google-cloud/bigquery-api)

BigQuery API client for Node.js

> **Notice**: `@google-cloud/bigquery-api` is an internal low-level GAPIC client intended to be consumed by `@google-cloud/bigquery`. Most users should install [`@google-cloud/bigquery`](https://www.npmjs.com/package/@google-cloud/bigquery) instead.
