...
> **Notice**: `@google-cloud/bigtable-api` is an internal low-level GAPIC client intended to be consumed by `@google-cloud/bigtable`. Most users should install [`@google-cloud/bigtable`](https://www.npmjs.com/package/@google-cloud/bigtable) instead.
