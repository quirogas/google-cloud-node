...
> **Notice**: `@google-cloud/logging-api` is an internal low-level GAPIC client intended to be consumed by `@google-cloud/logging`. Most users should install [`@google-cloud/logging`](https://www.npmjs.com/package/@google-cloud/logging) instead.
