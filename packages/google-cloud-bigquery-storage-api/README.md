...
> **Notice**: `@google-cloud/bigquery-storage-api` is an internal low-level GAPIC client intended to be consumed by `@google-cloud/bigquery-storage`. Most users should install [`@google-cloud/bigquery-storage`](https://www.npmjs.com/package/@google-cloud/bigquery-storage) instead.
