...
[![npm version](https://img.shields.io/npm/v/@google-cloud/firestore-api.svg)](https://www.npmjs.org/package/@google-cloud/firestore-api)

Cloud Firestore API client for Node.js

> **Notice**: `@google-cloud/firestore-api` is an internal low-level GAPIC client intended to be consumed by `@google-cloud/firestore`. Most users should install [`@google-cloud/firestore`](https://www.npmjs.com/package/@google-cloud/firestore) instead.
